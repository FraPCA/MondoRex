...
<link rel="stylesheet" href="stileCategorie.css"> <!-- stileCategorie sovrascrive alcune proprietà di stileCatalogo -->
...
<body>
	...
	<h1>Ecco i nostri prodotti per l'igiene e cura dei nostri amici a quattro zampe</h1>

	<% 
		Collection<ProductBean> pbL = new LinkedList<>();
		ProductDAO_DS pdao = new ProductDAO_DS();
		try {
			pbL = pdao.doRetrieveByCategory("IgieneeCura");
